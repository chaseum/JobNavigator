...
def _app_to_dict(a: Application, lookup=None, tailored=None, has_cover_letter=False) -> dict:
    ...
    return {
        ...
        "url": (job.apply_url or job.canonical_url or job.url) if job else None,
        ...
        "salary_currency": job.salary_currency if job else None,
        "salary_period": job.salary_period if job else None,
        "salary_source": job.salary_source if job else None,
